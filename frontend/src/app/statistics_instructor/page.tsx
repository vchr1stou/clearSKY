...
export default function StatisticsInstructor() {
  ...
  // Handler and effect functions copied from Statistics/page.tsx
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden" style={{ minHeight: "100vh", width: "100vw" }}>
      ...
      <Image
        ...
        priority
      />
      {/* Top Navigation Bar (from PostGrades) */}
      <div
        style={{
          position: "absolute",
          top: 30,
      ...
      {/* Main statistics UI copied from Statistics/page.tsx */}
      ...
      {selectedOption && (
        <>
          {/* Grade Distribution Rectangle and Bar Chart */}
          <div
            style={{
              position: "absolute",
              top: 130 + 85 + 60 + 42 + 25,
