...
export default function ChangePassword() {
  ...
  // Copy the UI from Add User, but update the title and button text
  return (
    <div className="relative min-h-screen w-full overflow-hidden" style={{ minHeight: "100vh", width: "100vw" }}>
      ...
      >
        <img
          ...
          width={24}
          height={23}
          style={{ position: "absolute", left: 20, top: 11, width: 24, height: 23, display: "block", cursor: "pointer" }}
      ...
      {/* Form rectangle centered below clearsky.svg */}
      <div
        style={{
          position: "absolute",
